...
class SysFacturacionesModel extends Model
{
  ...
  {
    return $this->belongsToMany(SysConceptosFacturacionesModel::class,'sys_users_facturaciones','id_facturacion','id_concepto');
  }
  ...
  {
    return $this->hasOne('App\Model\Administracion\Configuracion\SysTiposComprobantesModel','id','id_tipo_comprobante');
  }
  public function pedidos()
  {
    return $this->hasOne(SysPedidosModel::class,'id','id_pedidos');
  }
