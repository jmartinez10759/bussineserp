...
class SysPedidosModel extends Model
{
	  ...
	  {
	   	return $this->belongsToMany(SysConceptosPedidosModel::class,'sys_users_pedidos','id_pedido','id_concepto');
	  }
	  ...
	  {
	    return $this->hasOne(SysCotizacionModel::class,'id','id_cotizacion');
	  }
