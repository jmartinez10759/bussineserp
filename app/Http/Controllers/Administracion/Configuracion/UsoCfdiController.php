<?php
    ...
    class UsoCfdiController extends MasterController
    {
        ...
        */
        public function index(){
            ...
            return self::_load_view( "administracion.configuracion.usocfdi",$data );
        }
        /**
        ...
        */
        public function show( Request $request ){
            ...
            try {
                $where = ['id' => $request->id];
                $response = SysUsoCfdiModel::where( $where )->groupby('id')->get();
        ...
        */
        public function destroy( Request $request ){
            ...
            DB::beginTransaction();
            try {
                $response = SysUsoCfdiModel::where(['id' => $request->id])->delete();
