	...
	<div class="modal-dialog modal-lg">
		<div class="modal-content">
			...
			<div class="modal-body panel-body">
				...
				<form action="" class="form-horizontal row-border panel panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<!-- <input type="text" class="form-control" id="name" style="text-transform: capitalize;" v-model="newKeep.name"> -->
          ...
          <div class="form-group">
              ...
              <!-- <select class="form-control" id="cmb_sucursales" v-model="datos.empresas">
                <option>Todas las Sucursales</option>
                <optgroup v-for="(cliente,key) in datos.empresas" label="cliente.empresa">
                  <option v-for="(sucursales, key ) in empresas.sucursales">Mustard</option>
                </optgroup>
              </select> -->
