			...
			<div class="modal-body panel-body">
				...
				<form action="" class="form-horizontal row-border panel panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" v-model="fillKeep.descripcion">
						</div>
					</div>
			...
			<div class="modal-body panel-body">
				...
				<form action="" class="form-horizontal row-border panel panel-body">
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="clave_corta" style="text-transform: capitalize;" v-model="newKeep.clave_corta">
						</div>
					</div>
					...
					<div class="form-group">
						...
						<div class="col-sm-6">
							<input type="text" class="form-control" id="descripcion" v-model="newKeep.descripcion">
						</div>
					</div>
