...
@push('styles')
@endpush
<div ng-app="application" ng-controller="TiposComprobantesController" ng-init="constructor()" ng-cloak >   
            ...
            <div class="table-responsive">
                <table class="table table-striped table-responsive highlight table-hover fixed_header" id="datatable">
                    ...
                    <tbody>
                        ...
                        <tr ng-repeat="data in datos.tiposcomprobantes" id="tr_@{{data.id}}">
