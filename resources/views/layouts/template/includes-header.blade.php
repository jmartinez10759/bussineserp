  ...
  <!-- Bootstrap 3.3.7 -->
  <link rel="stylesheet" href="{{asset('admintle/bower_components/bootstrap/dist/css/bootstrap.min.css')}}">
  <!-- Styles -->
  ...
  <!-- DataTables -->
  <link rel="stylesheet" href="{{asset('admintle/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css')}}">
  <!-- Theme style -->
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="{{asset('admintle/bower_components/morris.js/morris.css')}}">
  <!-- jvectormap -->
  ...
  <link rel="stylesheet" href="{{asset('admintle/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css')}}">
